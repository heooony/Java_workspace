...
public class ElectronicsService {
	...
	List<Electronics> data = new ArrayList<Electronics> (5) {
			{
				new Electronics(10, "선풍기", 20000 ,"선풍기 너무 시원해요");
				new Electronics(20, "에어컨", 300000 ,"삼성 무풍 에어컨");
				new Electronics(30, "한갈세", 119900 ,"하 먹고싶다.");
				new Electronics(40, "부채살", 23000 ,"그냥 부채하다 생각남");
				new Electronics(50, "안창살", 12000 ,"아버지가 좋아하는 부위");
			}
		};
